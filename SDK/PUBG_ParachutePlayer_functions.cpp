...
void AParachutePlayer_C::UnknownFunction()
{
	static UFunction* fn = nullptr; 
	 if (!fn) fn = UObject::GetObjectCasted<UFunction>(56559);

	AParachutePlayer_C_UnknownFunction_Params params;
...
{
	static UFunction* fn = nullptr; 
	 if (!fn) fn = UObject::GetObjectCasted<UFunction>(56556);
